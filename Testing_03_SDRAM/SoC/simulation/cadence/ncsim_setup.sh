...
# ACDS 13.1 162 win32 2025.12.18.22:00:58
...
mkdir -p ./libraries/new_sdram_controller/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/SoC_new_sdram_controller.v"                  -work new_sdram_controller                                                     -cdslib ./cds_libs/new_sdram_controller.cds.lib                                                    
