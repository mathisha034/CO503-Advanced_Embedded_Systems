...
#define FIFO_1_WRITE_BASE   0x00021050

/* FIFO read interface (Avalon-MM read slave, if used) */
#define FIFO_1_READ_BASE    0x00021050

/* FIFO control & status interface (CSR) */
#define FIFO_1_CSR_BASE     0x00021000

/* FIFO interrupt number */
#define FIFO_1_IRQ    SHARED_FIFO_IN_USE_IRQ
...
#define FIFO_1_ALMOST_FULL    (SHARED_FIFO_IN_FIFO_DEPTH - 5)
