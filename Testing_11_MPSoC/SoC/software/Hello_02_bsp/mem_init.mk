...
# Memory: memory_1
MEM_0 := MPSoC_memory_1
$(MEM_0)_NAME := memory_1
...
$(MEM_0)_END := 0x00078fff
$(MEM_0)_HIERARCHICAL_PATH := memory_1
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: memory_1
memory_1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: memory_shared
MEM_1 := MPSoC_memory_shared
$(MEM_1)_NAME := memory_shared
...
$(MEM_1)_HIERARCHICAL_PATH := memory_shared
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: memory_shared
memory_shared: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
