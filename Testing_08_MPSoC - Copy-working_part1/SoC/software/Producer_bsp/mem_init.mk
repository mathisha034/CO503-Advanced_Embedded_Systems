...
# Memory: memory_0
MEM_0 := MPSoC_memory_0
$(MEM_0)_NAME := memory_0
...
$(MEM_0)_HIERARCHICAL_PATH := memory_0
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: memory_0
memory_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
