...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1_rsp_xbar_mux.sv"               -work rsp_xbar_mux                                                            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1_rsp_xbar_demux.sv"             -work rsp_xbar_demux                                                          
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work cmd_xbar_mux                                                            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1_cmd_xbar_mux.sv"               -work cmd_xbar_mux                                                            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1_cmd_xbar_demux.sv"             -work cmd_xbar_demux                                                          
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1_id_router.sv"                  -work id_router                                                               
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1_addr_router.sv"                -work addr_router                                                             
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_rsp_xbar_mux_001.sv"           -work rsp_xbar_mux_001                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work rsp_xbar_mux                                                            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_rsp_xbar_mux.sv"               -work rsp_xbar_mux                                                            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_rsp_xbar_demux_005.sv"         -work rsp_xbar_demux_005                                                      
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_rsp_xbar_demux_002.sv"         -work rsp_xbar_demux_002                                                      
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work cmd_xbar_mux_005                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_cmd_xbar_mux_005.sv"           -work cmd_xbar_mux_005                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work cmd_xbar_mux_002                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_cmd_xbar_mux_002.sv"           -work cmd_xbar_mux_002                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work cmd_xbar_mux                                                            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_cmd_xbar_mux.sv"               -work cmd_xbar_mux                                                            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_cmd_xbar_demux_001.sv"         -work cmd_xbar_demux_001                                                      
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_cmd_xbar_demux.sv"             -work cmd_xbar_demux                                                          
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_id_router_005.sv"              -work id_router_005                                                           
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_id_router_002.sv"              -work id_router_002                                                           
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_id_router.sv"                  -work id_router                                                               
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_addr_router_001.sv"            -work addr_router_001                                                         
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_addr_router.sv"                -work addr_router                                                             
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_irq_mapper.sv"                                   -work irq_mapper                                                              
  vlogan +v2k           "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1.v"                             -work mm_interconnect_1                                                       
  vlogan +v2k           "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0.v"                             -work mm_interconnect_0                                                       
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_cpu_custom_instruction_master_multi_xconnect.sv" -work cpu_custom_instruction_master_multi_xconnect                            
