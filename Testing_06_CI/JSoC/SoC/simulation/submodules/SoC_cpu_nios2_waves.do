add wave -noupdate -divider {SoC_cpu: top-level ports}
...
add wave -noupdate -divider {SoC_cpu: common}
...
add wave -noupdate -divider {SoC_cpu: breaks}
...
add wave -noupdate -divider {SoC_cpu: custom_instruction}
