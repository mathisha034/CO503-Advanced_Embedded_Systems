...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1_rsp_xbar_mux.sv"               -work rsp_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1_rsp_xbar_demux.sv"             -work rsp_xbar_demux                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work cmd_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1_cmd_xbar_mux.sv"               -work cmd_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1_cmd_xbar_demux.sv"             -work cmd_xbar_demux                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                    -work limiter                                                                 
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                     -work limiter                                                                 
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                             -work limiter                                                                 
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                    -work limiter                                                                 
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1_id_router.sv"                  -work id_router                                                               
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1_addr_router.sv"                -work addr_router                                                             
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_rsp_xbar_mux_001.sv"           -work rsp_xbar_mux_001                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work rsp_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_rsp_xbar_mux.sv"               -work rsp_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_rsp_xbar_demux_005.sv"         -work rsp_xbar_demux_005                                                      
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_rsp_xbar_demux_002.sv"         -work rsp_xbar_demux_002                                                      
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work cmd_xbar_mux_005                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_cmd_xbar_mux_005.sv"           -work cmd_xbar_mux_005                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work cmd_xbar_mux_002                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_cmd_xbar_mux_002.sv"           -work cmd_xbar_mux_002                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                         -work cmd_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_cmd_xbar_mux.sv"               -work cmd_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_cmd_xbar_demux_001.sv"         -work cmd_xbar_demux_001                                                      
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_cmd_xbar_demux.sv"             -work cmd_xbar_demux                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_id_router_005.sv"              -work id_router_005                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_id_router_002.sv"              -work id_router_002                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_id_router.sv"                  -work id_router                                                               
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_addr_router_001.sv"            -work addr_router_001                                                         
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_addr_router.sv"                -work addr_router                                                             
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_irq_mapper.sv"                                   -work irq_mapper                                                              
  vlog     "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_1.v"                             -work mm_interconnect_1                                                       
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_cpu_custom_instruction_master_multi_xconnect.sv" -work cpu_custom_instruction_master_multi_xconnect                            
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L limiter -L id_router -L addr_router -L crosser -L rsp_xbar_mux_001 -L rsp_xbar_demux_005 -L rsp_xbar_demux_002 -L cmd_xbar_mux_005 -L cmd_xbar_mux_002 -L cmd_xbar_demux_001 -L id_router_005 -L id_router_002 -L addr_router_001 -L cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent -L cpu_instruction_master_translator_avalon_universal_master_0_agent -L cpu_jtag_debug_module_translator -L cpu_instruction_master_translator -L rst_controller -L irq_synchronizer -L irq_mapper -L mm_interconnect_1 -L mm_interconnect_0 -L cpu_custom_instruction_master_multi_slave_translator0 -L cpu_custom_instruction_master_multi_xconnect -L cpu_custom_instruction_master_translator -L pll -L mm_clock_crossing_bridge -L led_out -L sysid -L timer -L jtag_uart -L cpu -L sdram_controller -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L limiter -L id_router -L addr_router -L crosser -L rsp_xbar_mux_001 -L rsp_xbar_demux_005 -L rsp_xbar_demux_002 -L cmd_xbar_mux_005 -L cmd_xbar_mux_002 -L cmd_xbar_demux_001 -L id_router_005 -L id_router_002 -L addr_router_001 -L cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent -L cpu_instruction_master_translator_avalon_universal_master_0_agent -L cpu_jtag_debug_module_translator -L cpu_instruction_master_translator -L rst_controller -L irq_synchronizer -L irq_mapper -L mm_interconnect_1 -L mm_interconnect_0 -L cpu_custom_instruction_master_multi_slave_translator0 -L cpu_custom_instruction_master_multi_xconnect -L cpu_custom_instruction_master_translator -L pll -L mm_clock_crossing_bridge -L led_out -L sysid -L timer -L jtag_uart -L cpu -L sdram_controller -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
