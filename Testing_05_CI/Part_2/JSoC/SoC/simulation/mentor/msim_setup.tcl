...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_rsp_xbar_demux_003.sv" -work rsp_xbar_demux_003                                                      
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_rsp_xbar_demux_002.sv" -work rsp_xbar_demux_002                                                      
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                 -work cmd_xbar_mux_003                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_cmd_xbar_mux_003.sv"   -work cmd_xbar_mux_003                                                        
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_id_router_003.sv"      -work id_router_003                                                           
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L limiter -L id_router -L addr_router -L crosser -L rsp_xbar_mux_001 -L rsp_xbar_demux_003 -L rsp_xbar_demux_002 -L cmd_xbar_mux_003 -L cmd_xbar_mux_002 -L cmd_xbar_demux_001 -L id_router_003 -L id_router_002 -L addr_router_001 -L cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent -L cpu_instruction_master_translator_avalon_universal_master_0_agent -L cpu_jtag_debug_module_translator -L cpu_instruction_master_translator -L rst_controller -L irq_synchronizer -L irq_mapper -L mm_interconnect_1 -L mm_interconnect_0 -L mm_clock_crossing_bridge -L led_out -L sysid -L timer -L jtag_uart -L cpu -L pll -L sdram_controller -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L limiter -L id_router -L addr_router -L crosser -L rsp_xbar_mux_001 -L rsp_xbar_demux_003 -L rsp_xbar_demux_002 -L cmd_xbar_mux_003 -L cmd_xbar_mux_002 -L cmd_xbar_demux_001 -L id_router_003 -L id_router_002 -L addr_router_001 -L cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent -L cpu_instruction_master_translator_avalon_universal_master_0_agent -L cpu_jtag_debug_module_translator -L cpu_instruction_master_translator -L rst_controller -L irq_synchronizer -L irq_mapper -L mm_interconnect_1 -L mm_interconnect_0 -L mm_clock_crossing_bridge -L led_out -L sysid -L timer -L jtag_uart -L cpu -L pll -L sdram_controller -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
