...
# Memory: new_sdram_controller
MEM_0 := new_sdram_controller
$(MEM_0)_NAME := new_sdram_controller
...
$(MEM_0)_HIERARCHICAL_PATH := new_sdram_controller
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: new_sdram_controller
new_sdram_controller: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
