...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_rsp_xbar_demux_003.sv" -work rsp_xbar_demux_003                                                      
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_cmd_xbar_mux_003.sv"   -work cmd_xbar_mux_003                                                        
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/SoC_mm_interconnect_0_id_router_003.sv"      -work id_router_003                                                           
