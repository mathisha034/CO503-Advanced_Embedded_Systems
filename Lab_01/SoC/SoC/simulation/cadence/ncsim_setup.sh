...
# ACDS 13.1 162 win32 2025.12.15.15:45:46
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  ...
  cp -f $QSYS_SIMDIR/submodules/SoC_onchip_mem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/SoC_onchip_mem.v"                            -work onchip_mem                                                               -cdslib ./cds_libs/onchip_mem.cds.lib                                                              
