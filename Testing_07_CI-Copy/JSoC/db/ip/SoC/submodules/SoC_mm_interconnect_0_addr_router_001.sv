...
(
    ...
    localparam PAD4 = log2ceil(64'h9001050 - 64'h9001040); 
    localparam PAD5 = log2ceil(64'h9001060 - 64'h9001050); 
    localparam PAD6 = log2ceil(64'h9001068 - 64'h9001060); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h9001068;
    ...
    // ( 0x9001050 .. 0x9001060 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 28'h9001050   ) begin
            src_channel = 7'b0001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x9001060 .. 0x9001068 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 28'h9001060   ) begin
